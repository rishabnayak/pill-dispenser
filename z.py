...
bus.write_word_data(addr, 0x0E, 0)     # chl 0 start time = 0us
bus.write_word_data(addr, 0x10, 1250)  # chl 0 end time = 1.5ms
...
bus.write_word_data(addr, 0x10, 836)  # chl 0 end time = 1.0ms
time.sleep(1)
